export const PROGRAMS = {
  CORE: "autoperp_core_private_v9.aleo",
  AGENT: "autoperp_agent_v3.aleo",
  ORACLE: "autoperp_oracle_v2.aleo",
  USDCX: "test_usdcx_stablecoin.aleo",
} as const;

export const PRIVATE_CORE_PROGRAM = "autoperp_core_private_v9.aleo";
export const PUBLIC_CORE_PROGRAM = "autoperp_core_v9.aleo";
...
export const PROGRAM_ADDRESSES = {
  CORE: "", // Will be populated after V9 deployment
} as const;

export const REAL_SETTLEMENT_AVAILABLE = true;

export const LEGACY_SETTLEMENT_MESSAGE =
  "Legacy AutoPerp deployments only updated internal bookkeeping. Redeploy autoperp_core_v9.aleo before allowing live USDCx-backed deposits, liquidity, or trading.";
